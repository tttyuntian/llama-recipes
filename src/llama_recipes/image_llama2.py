...
from llama_recipes.models.object_centric_llama import ObjectCentricLlama
...
def update_train_config(train_config, model_name, quantization, lr, num_epochs, gradient_accumulation_steps, batch_size, validation_steps, image_model, num_workers, is_train_image_encoder, output_dir):
...
def main(
    ...
    **kwargs,
    ...
    train_config = update_train_config(train_config, model_name, quantization, lr, num_epochs, gradient_accumulation_steps, batch_size, validation_steps, image_model, num_workers, is_train_image_encoder, output_dir)
    ...
    model = ObjectCentricLlama(llama_model, image_model, train_config.image_model, image_hidden_size, mask_token_id=tokenizer.mask_token_id, use_visual_encoder=True, is_train_image_encoder=train_config.is_train_image_encoder)
